    ...
    <Layout>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-soft border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-2">Import from Pepperplate</h2>
          <p className="text-sm text-gray-600 mb-4">
            Export your recipes from Pepperplate.com (Profile → Export Recipe Data), then upload the
            .zip file here.
          </p>
          ...
          {!results ? (
              ...
              >
                ...
                {file ? (
                  ...
                  <div className="text-gray-500">
                    ...
                    <p className="font-medium">Drop your Pepperplate export here</p>
            ...
            <div>
              ...
              {results.skipped?.length > 0 && (
                <div className="mb-4">
                  <h4 className="font-medium text-gray-700 mb-2">Skipped (duplicates)</h4>
        ...
        <div className="bg-white rounded-xl shadow-soft border border-gray-200 p-6 mt-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-2">Auto-Tag Recipes</h2>
          <p className="text-sm text-gray-600 mb-4">
            Automatically assign cuisines, meal types, and dietary labels to your recipes based on
            their titles and ingredients.
          </p>

          {autoTagResults ? (
            <div>
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                <h3 className="font-semibold text-green-800 mb-2">Auto-Tagging Complete</h3>
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <p className="text-2xl font-bold text-green-700">{autoTagResults.tagged}</p>
                    <p className="text-sm text-green-600">Recipes Tagged</p>
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-gray-500">{autoTagResults.total}</p>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                &quot;Tag Uncategorized&quot; only processes recipes with no categories assigned.
                &quot;Re-tag All&quot; overwrites existing categories.
              </p>
            </div>
          )}
        </div>
