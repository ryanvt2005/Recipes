                    ...
                    >
                      ...
                      <button
                        ...
                        className={`w-full flex items-start gap-3 p-3 text-left ${
                          !item.is_checked ? 'active:bg-primary-50' : ''
                        }`}
                      >
                      ...
                      {/* Actions row: category selector + delete — below item on mobile, inline on desktop */}
                      <div className="flex items-center gap-2 px-3 pb-3 pt-0 sm:pt-0 no-print">
                        <select
                          ...
                          onClick={(e) => e.stopPropagation()}
                          className="text-xs px-2 py-1 min-h-[32px] border border-gray-300 rounded bg-white hover:border-primary-400 focus:ring-1 focus:ring-primary-500 focus:border-primary-500 flex-shrink-0"
                        >
