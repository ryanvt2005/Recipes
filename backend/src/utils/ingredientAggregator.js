...
const INGREDIENT_FAMILY_MAP = [
  ...
  { pattern: /\b(cheddar|sharp cheddar|mild cheddar|white cheddar|yellow cheddar|aged cheddar)\s*(cheese)?\b/i, canonical: 'cheddar cheese', display: 'Cheddar cheese' },
  { pattern: /\b(mozzarella|fresh mozzarella|part[- ]?skim mozzarella)\s*(cheese)?\b/i, canonical: 'mozzarella cheese', display: 'Mozzarella cheese' },
  { pattern: /\b(parmesan|parmigiano[- ]?reggiano|parm)\s*(cheese)?\b/i, canonical: 'parmesan cheese', display: 'Parmesan cheese' },
  { pattern: /\b(swiss|gruyere|gruyère|emmental|emmentaler)\s*(cheese)?\b/i, canonical: 'swiss cheese', display: 'Swiss cheese' },
  ...
  { pattern: /\b(cream cheese|neufchâtel|neufchatel)\b/i, canonical: 'cream cheese', display: 'Cream cheese' },
  ...
  { pattern: /\b(blue cheese|bleu cheese|gorgonzola|roquefort|stilton)\b/i, canonical: 'blue cheese', display: 'Blue cheese' },
  { pattern: /\b(monterey jack|pepper jack|colby[- ]?jack|colby)\s*(cheese)?\b/i, canonical: 'jack cheese', display: 'Jack cheese' },
  { pattern: /\b(provolone)\s*(cheese)?\b/i, canonical: 'provolone cheese', display: 'Provolone cheese' },
  { pattern: /\b(american cheese|american)\s*(cheese)?\b/i, canonical: 'american cheese', display: 'American cheese' },
  { pattern: /\b(brie)\s*(cheese)?\b/i, canonical: 'brie cheese', display: 'Brie cheese' },
  { pattern: /\b(camembert)\s*(cheese)?\b/i, canonical: 'camembert cheese', display: 'Camembert cheese' },
  { pattern: /\b(manchego)\s*(cheese)?\b/i, canonical: 'manchego cheese', display: 'Manchego cheese' },
  ...
  { pattern: /\b(pecorino|pecorino romano)\s*(cheese)?\b/i, canonical: 'pecorino cheese', display: 'Pecorino cheese' },

  // Butter variants
  { pattern: /\b(butter|unsalted butter|salted butter|sweet cream butter)\b/i, canonical: 'butter', display: 'Butter' },

  // Milk variants
  { pattern: /\b(milk|whole milk|2% milk|1% milk|skim milk|fat[- ]?free milk|nonfat milk)\b/i, canonical: 'milk', display: 'Milk' },
  { pattern: /\b(buttermilk|cultured buttermilk)\b/i, canonical: 'buttermilk', display: 'Buttermilk' },
  { pattern: /\b(half[- ]?and[- ]?half|half & half)\b/i, canonical: 'half and half', display: 'Half and half' },
  { pattern: /\b(heavy cream|heavy whipping cream|whipping cream)\b/i, canonical: 'heavy cream', display: 'Heavy cream' },
  { pattern: /\b(sour cream)\b/i, canonical: 'sour cream', display: 'Sour cream' },

  // Yogurt variants
  { pattern: /\b(yogurt|greek yogurt|plain yogurt|vanilla yogurt|low[- ]?fat yogurt|nonfat yogurt)\b/i, canonical: 'yogurt', display: 'Yogurt' },

  // Onion variants - more specific patterns first
  { pattern: /\b(red onion|purple onion)\b/i, canonical: 'red onion', display: 'Red onion' },
  { pattern: /\b(green onion|scallion|spring onion)\b/i, canonical: 'green onion', display: 'Green onion' },
  { pattern: /\b(shallot)\b/i, canonical: 'shallot', display: 'Shallot' },
  { pattern: /\b(onion|yellow onion|white onion|sweet onion|vidalia onion|spanish onion)\b/i, canonical: 'onion', display: 'Onion' },

  // Garlic variants
  { pattern: /\b(garlic|garlic clove|clove of garlic|cloves of garlic|garlic cloves)\b/i, canonical: 'garlic', display: 'Garlic' },
  ...
  { pattern: /\b(minced garlic|crushed garlic|chopped garlic)\b/i, canonical: 'garlic', display: 'Garlic' },

  // Salt variants - combine all salt types into one family (notes will show breakdown)
  { pattern: /\b(kosher salt|coarse salt|sea salt|flaky salt|fleur de sel|table salt|fine salt|iodized salt)\b/i, canonical: 'salt', display: 'Salt' },
  { pattern: /^salt$/i, canonical: 'salt', display: 'Salt' },

  // Pepper variants
  { pattern: /\b(black pepper|ground black pepper|freshly ground black pepper|cracked black pepper|peppercorns)\b/i, canonical: 'black pepper', display: 'Black pepper' },
  { pattern: /\b(white pepper|ground white pepper)\b/i, canonical: 'white pepper', display: 'White pepper' },
  { pattern: /\b(cayenne pepper|cayenne|ground cayenne)\b/i, canonical: 'cayenne pepper', display: 'Cayenne pepper' },

  // Oil variants
  { pattern: /\b(olive oil|extra virgin olive oil|virgin olive oil|evoo|light olive oil)\b/i, canonical: 'olive oil', display: 'Olive oil' },
  { pattern: /\b(vegetable oil|canola oil|neutral oil)\b/i, canonical: 'vegetable oil', display: 'Vegetable oil' },
  { pattern: /\b(coconut oil)\b/i, canonical: 'coconut oil', display: 'Coconut oil' },
  { pattern: /\b(sesame oil|toasted sesame oil)\b/i, canonical: 'sesame oil', display: 'Sesame oil' },
  { pattern: /\b(avocado oil)\b/i, canonical: 'avocado oil', display: 'Avocado oil' },

  // Flour variants
  { pattern: /\b(all[- ]?purpose flour|ap flour|plain flour)\b/i, canonical: 'all-purpose flour', display: 'All-purpose flour' },
  { pattern: /\b(bread flour|high[- ]?gluten flour)\b/i, canonical: 'bread flour', display: 'Bread flour' },
  { pattern: /\b(cake flour|pastry flour)\b/i, canonical: 'cake flour', display: 'Cake flour' },
  { pattern: /\b(whole wheat flour|whole[- ]?grain flour|wheat flour)\b/i, canonical: 'whole wheat flour', display: 'Whole wheat flour' },
  { pattern: /\b(self[- ]?rising flour|self[- ]?raising flour)\b/i, canonical: 'self-rising flour', display: 'Self-rising flour' },
  { pattern: /^flour$/i, canonical: 'all-purpose flour', display: 'All-purpose flour' },

  // Sugar variants
  { pattern: /\b(granulated sugar|white sugar|table sugar|cane sugar)\b/i, canonical: 'sugar', display: 'Sugar' },
  { pattern: /\b(brown sugar|light brown sugar|dark brown sugar|packed brown sugar)\b/i, canonical: 'brown sugar', display: 'Brown sugar' },
  { pattern: /\b(powdered sugar|confectioners sugar|confectioner's sugar|icing sugar|10x sugar)\b/i, canonical: 'powdered sugar', display: 'Powdered sugar' },
  { pattern: /^sugar$/i, canonical: 'sugar', display: 'Sugar' },

  // Tomato variants
  { pattern: /\b(tomato|roma tomato|plum tomato|beefsteak tomato|heirloom tomato)\b/i, canonical: 'tomato', display: 'Tomato' },
  { pattern: /\b(cherry tomato|grape tomato)\b/i, canonical: 'cherry tomato', display: 'Cherry tomato' },
  ...
  { pattern: /\b(crushed tomato|diced tomato|canned tomato|whole tomato|san marzano)\b/i, canonical: 'canned tomato', display: 'Canned tomatoes' },
  { pattern: /\b(sun[- ]?dried tomato)\b/i, canonical: 'sun-dried tomato', display: 'Sun-dried tomatoes' },
  ...
  // Chicken variants
  { pattern: /\b(chicken breast|boneless chicken breast|skinless chicken breast|chicken cutlet)\b/i, canonical: 'chicken breast', display: 'Chicken breast' },
  { pattern: /\b(chicken thigh|boneless chicken thigh|skinless chicken thigh)\b/i, canonical: 'chicken thigh', display: 'Chicken thigh' },
  { pattern: /\b(ground chicken)\b/i, canonical: 'ground chicken', display: 'Ground chicken' },
  { pattern: /\b(whole chicken|roasting chicken)\b/i, canonical: 'whole chicken', display: 'Whole chicken' },

  // Beef variants
  { pattern: /\b(ground beef|lean ground beef|ground chuck|ground sirloin|minced beef)\b/i, canonical: 'ground beef', display: 'Ground beef' },
  { pattern: /\b(beef steak|steak|sirloin|ribeye|rib[- ]?eye|filet|fillet|strip steak|ny strip|new york strip|t[- ]?bone|porterhouse)\b/i, canonical: 'beef steak', display: 'Beef steak' },
  { pattern: /\b(beef roast|chuck roast|pot roast|brisket)\b/i, canonical: 'beef roast', display: 'Beef roast' },

  // Pork variants
  { pattern: /\b(ground pork)\b/i, canonical: 'ground pork', display: 'Ground pork' },
  { pattern: /\b(pork chop|bone[- ]?in pork chop|boneless pork chop)\b/i, canonical: 'pork chop', display: 'Pork chop' },
  { pattern: /\b(pork tenderloin|pork loin)\b/i, canonical: 'pork loin', display: 'Pork loin' },
  { pattern: /\b(bacon|thick[- ]?cut bacon|applewood bacon|smoked bacon)\b/i, canonical: 'bacon', display: 'Bacon' },
  { pattern: /\b(ham|smoked ham|honey ham|deli ham)\b/i, canonical: 'ham', display: 'Ham' },
  { pattern: /\b(sausage|italian sausage|breakfast sausage|pork sausage)\b/i, canonical: 'sausage', display: 'Sausage' },

  // Lemon/lime variants
  { pattern: /\b(lemon|fresh lemon|meyer lemon)\b/i, canonical: 'lemon', display: 'Lemon' },
  { pattern: /\b(lemon juice|fresh lemon juice|freshly squeezed lemon juice)\b/i, canonical: 'lemon juice', display: 'Lemon juice' },
  ...
  { pattern: /\b(lime juice|fresh lime juice|freshly squeezed lime juice)\b/i, canonical: 'lime juice', display: 'Lime juice' },
  { pattern: /\b(lime zest)\b/i, canonical: 'lime zest', display: 'Lime zest' },

  // Vinegar variants
  { pattern: /\b(white vinegar|distilled white vinegar|distilled vinegar)\b/i, canonical: 'white vinegar', display: 'White vinegar' },
  { pattern: /\b(apple cider vinegar|cider vinegar)\b/i, canonical: 'apple cider vinegar', display: 'Apple cider vinegar' },
  { pattern: /\b(balsamic vinegar|aged balsamic)\b/i, canonical: 'balsamic vinegar', display: 'Balsamic vinegar' },
  { pattern: /\b(red wine vinegar)\b/i, canonical: 'red wine vinegar', display: 'Red wine vinegar' },
  { pattern: /\b(white wine vinegar)\b/i, canonical: 'white wine vinegar', display: 'White wine vinegar' },
  { pattern: /\b(rice vinegar|rice wine vinegar)\b/i, canonical: 'rice vinegar', display: 'Rice vinegar' },

  // Herb variants
  { pattern: /\b(parsley|fresh parsley|flat[- ]?leaf parsley|italian parsley|curly parsley)\b/i, canonical: 'parsley', display: 'Parsley' },
  { pattern: /\b(dried parsley)\b/i, canonical: 'dried parsley', display: 'Dried parsley' },
  { pattern: /\b(cilantro|fresh cilantro|coriander leaves)\b/i, canonical: 'cilantro', display: 'Cilantro' },
  { pattern: /\b(basil|fresh basil|sweet basil|thai basil)\b/i, canonical: 'basil', display: 'Basil' },
  ...
  // Spice variants
  { pattern: /\b(cinnamon|ground cinnamon|cinnamon stick)\b/i, canonical: 'cinnamon', display: 'Cinnamon' },
  { pattern: /\b(nutmeg|ground nutmeg|whole nutmeg|freshly grated nutmeg)\b/i, canonical: 'nutmeg', display: 'Nutmeg' },
  { pattern: /\b(cumin|ground cumin|cumin seed)\b/i, canonical: 'cumin', display: 'Cumin' },
  { pattern: /\b(paprika|smoked paprika|sweet paprika|hot paprika|hungarian paprika)\b/i, canonical: 'paprika', display: 'Paprika' },
  { pattern: /\b(chili powder|chile powder)\b/i, canonical: 'chili powder', display: 'Chili powder' },
  { pattern: /\b(curry powder)\b/i, canonical: 'curry powder', display: 'Curry powder' },
  { pattern: /\b(ginger|fresh ginger|ground ginger|ginger root|minced ginger)\b/i, canonical: 'ginger', display: 'Ginger' },
  { pattern: /\b(turmeric|ground turmeric)\b/i, canonical: 'turmeric', display: 'Turmeric' },
  { pattern: /\b(coriander|ground coriander|coriander seed)\b/i, canonical: 'coriander', display: 'Coriander' },
  ...
  { pattern: /\b(cardamom|ground cardamom|cardamom pod)\b/i, canonical: 'cardamom', display: 'Cardamom' },

  // Broth/stock variants
  { pattern: /\b(chicken broth|chicken stock|low[- ]?sodium chicken broth)\b/i, canonical: 'chicken broth', display: 'Chicken broth' },
  { pattern: /\b(beef broth|beef stock|low[- ]?sodium beef broth)\b/i, canonical: 'beef broth', display: 'Beef broth' },
  { pattern: /\b(vegetable broth|vegetable stock|veggie broth)\b/i, canonical: 'vegetable broth', display: 'Vegetable broth' },

  // Soy sauce variants
  { pattern: /\b(soy sauce|low[- ]?sodium soy sauce|light soy sauce|dark soy sauce|tamari)\b/i, canonical: 'soy sauce', display: 'Soy sauce' },

  // Mustard variants
  { pattern: /\b(dijon mustard|dijon)\b/i, canonical: 'dijon mustard', display: 'Dijon mustard' },
  { pattern: /\b(yellow mustard|american mustard|prepared mustard)\b/i, canonical: 'yellow mustard', display: 'Yellow mustard' },
  { pattern: /\b(whole grain mustard|stone ground mustard|coarse mustard)\b/i, canonical: 'whole grain mustard', display: 'Whole grain mustard' },
  { pattern: /\b(dry mustard|mustard powder)\b/i, canonical: 'dry mustard', display: 'Dry mustard' },

  // Honey/syrup variants
  { pattern: /\b(honey|raw honey|clover honey|wildflower honey)\b/i, canonical: 'honey', display: 'Honey' },
  { pattern: /\b(maple syrup|pure maple syrup)\b/i, canonical: 'maple syrup', display: 'Maple syrup' },

  // Rice variants
  { pattern: /\b(white rice|long[- ]?grain rice|basmati rice|jasmine rice)\b/i, canonical: 'white rice', display: 'White rice' },
  { pattern: /\b(brown rice|long[- ]?grain brown rice)\b/i, canonical: 'brown rice', display: 'Brown rice' },
  { pattern: /\b(arborio rice|risotto rice)\b/i, canonical: 'arborio rice', display: 'Arborio rice' },
  { pattern: /^rice$/i, canonical: 'white rice', display: 'White rice' },

  // Pasta variants
  { pattern: /\b(spaghetti|thin spaghetti|angel hair)\b/i, canonical: 'spaghetti', display: 'Spaghetti' },
  { pattern: /\b(penne|rigatoni|ziti)\b/i, canonical: 'penne', display: 'Penne' },
  { pattern: /\b(fettuccine|fettuccini|tagliatelle)\b/i, canonical: 'fettuccine', display: 'Fettuccine' },
  { pattern: /\b(macaroni|elbow macaroni|elbow pasta)\b/i, canonical: 'macaroni', display: 'Macaroni' },
  { pattern: /\b(lasagna|lasagne|lasagna noodle|lasagna sheet)\b/i, canonical: 'lasagna noodles', display: 'Lasagna noodles' },

  // Bread variants
  { pattern: /\b(bread|white bread|sandwich bread|sliced bread)\b/i, canonical: 'bread', display: 'Bread' },
  { pattern: /\b(bread crumb|breadcrumb|panko|panko breadcrumb)\b/i, canonical: 'breadcrumbs', display: 'Breadcrumbs' },

  // Bean variants
  { pattern: /\b(black bean|canned black bean)\b/i, canonical: 'black beans', display: 'Black beans' },
  { pattern: /\b(kidney bean|red kidney bean|canned kidney bean)\b/i, canonical: 'kidney beans', display: 'Kidney beans' },
  { pattern: /\b(pinto bean|canned pinto bean)\b/i, canonical: 'pinto beans', display: 'Pinto beans' },
  { pattern: /\b(cannellini bean|white bean|great northern bean|navy bean)\b/i, canonical: 'white beans', display: 'White beans' },
  { pattern: /\b(chickpea|garbanzo bean|canned chickpea)\b/i, canonical: 'chickpeas', display: 'Chickpeas' },
  { pattern: /\b(lentil|green lentil|brown lentil|red lentil)\b/i, canonical: 'lentils', display: 'Lentils' },

  // Nut variants
  { pattern: /\b(almond|whole almond|sliced almond|slivered almond)\b/i, canonical: 'almonds', display: 'Almonds' },
  ...
  { pattern: /\b(peanut|roasted peanut|unsalted peanut|salted peanut)\b/i, canonical: 'peanuts', display: 'Peanuts' },
  ...
  // Potato variants
  { pattern: /\b(potato|russet potato|idaho potato|baking potato|yukon gold|yellow potato)\b/i, canonical: 'potato', display: 'Potato' },
  { pattern: /\b(red potato|new potato|baby potato|fingerling)\b/i, canonical: 'red potato', display: 'Red potato' },
  { pattern: /\b(sweet potato|yam)\b/i, canonical: 'sweet potato', display: 'Sweet potato' },

  // Lettuce/greens variants
  { pattern: /\b(lettuce|romaine|romaine lettuce|iceberg|iceberg lettuce|butter lettuce|bibb lettuce)\b/i, canonical: 'lettuce', display: 'Lettuce' },
  { pattern: /\b(spinach|baby spinach|fresh spinach)\b/i, canonical: 'spinach', display: 'Spinach' },
  { pattern: /\b(kale|curly kale|lacinato kale|tuscan kale)\b/i, canonical: 'kale', display: 'Kale' },
  { pattern: /\b(arugula|rocket)\b/i, canonical: 'arugula', display: 'Arugula' },
  { pattern: /\b(mixed greens|salad greens|spring mix|mesclun)\b/i, canonical: 'mixed greens', display: 'Mixed greens' },

  // Mushroom variants
  { pattern: /\b(mushroom|white mushroom|button mushroom|cremini|crimini|baby bella)\b/i, canonical: 'mushroom', display: 'Mushroom' },
  { pattern: /\b(portobello|portabella|portabello mushroom)\b/i, canonical: 'portobello mushroom', display: 'Portobello mushroom' },
  { pattern: /\b(shiitake|shiitake mushroom)\b/i, canonical: 'shiitake mushroom', display: 'Shiitake mushroom' },

  // Cucumber variants
  { pattern: /\b(cucumber|english cucumber|persian cucumber|hothouse cucumber)\b/i, canonical: 'cucumber', display: 'Cucumber' },

  // Avocado variants
  { pattern: /\b(avocado|hass avocado|ripe avocado)\b/i, canonical: 'avocado', display: 'Avocado' },

  // Corn variants
  { pattern: /\b(corn|sweet corn|corn kernel|canned corn|frozen corn)\b/i, canonical: 'corn', display: 'Corn' },
  { pattern: /\b(corn on the cob|ear of corn)\b/i, canonical: 'corn on the cob', display: 'Corn on the cob' },

  // Zucchini/squash variants
  { pattern: /\b(zucchini|courgette)\b/i, canonical: 'zucchini', display: 'Zucchini' },
  { pattern: /\b(yellow squash|summer squash)\b/i, canonical: 'yellow squash', display: 'Yellow squash' },
  { pattern: /\b(butternut squash)\b/i, canonical: 'butternut squash', display: 'Butternut squash' },
  { pattern: /\b(acorn squash)\b/i, canonical: 'acorn squash', display: 'Acorn squash' },
  { pattern: /\b(spaghetti squash)\b/i, canonical: 'spaghetti squash', display: 'Spaghetti squash' },

  // Broccoli/cauliflower
  { pattern: /\b(broccoli|broccoli floret|broccoli crown)\b/i, canonical: 'broccoli', display: 'Broccoli' },
  { pattern: /\b(cauliflower|cauliflower floret)\b/i, canonical: 'cauliflower', display: 'Cauliflower' },

  // Asparagus
  { pattern: /\b(asparagus|asparagus spear)\b/i, canonical: 'asparagus', display: 'Asparagus' },

  // Green beans
  { pattern: /\b(green bean|string bean|snap bean|haricot vert)\b/i, canonical: 'green beans', display: 'Green beans' },

  // Pea variants
  { pattern: /\b(pea|green pea|english pea|garden pea|frozen pea)\b/i, canonical: 'peas', display: 'Peas' },
  { pattern: /\b(snow pea)\b/i, canonical: 'snow peas', display: 'Snow peas' },
  { pattern: /\b(sugar snap pea|snap pea)\b/i, canonical: 'sugar snap peas', display: 'Sugar snap peas' },

  // Cabbage variants
  { pattern: /\b(cabbage|green cabbage|white cabbage)\b/i, canonical: 'cabbage', display: 'Cabbage' },
  { pattern: /\b(red cabbage|purple cabbage)\b/i, canonical: 'red cabbage', display: 'Red cabbage' },
  { pattern: /\b(napa cabbage|chinese cabbage)\b/i, canonical: 'napa cabbage', display: 'Napa cabbage' },

  // Eggplant
  { pattern: /\b(eggplant|aubergine)\b/i, canonical: 'eggplant', display: 'Eggplant' },

  // Hot pepper variants (keep separate from bell peppers)
  { pattern: /\b(jalapeño|jalapeno|jalapeño pepper|jalapeno pepper)\b/i, canonical: 'jalapeño', display: 'Jalapeño' },
  { pattern: /\b(serrano|serrano pepper)\b/i, canonical: 'serrano pepper', display: 'Serrano pepper' },
  { pattern: /\b(habanero|habanero pepper)\b/i, canonical: 'habanero pepper', display: 'Habanero pepper' },
  { pattern: /\b(poblano|poblano pepper)\b/i, canonical: 'poblano pepper', display: 'Poblano pepper' },
  { pattern: /\b(chipotle|chipotle pepper|chipotle in adobo)\b/i, canonical: 'chipotle pepper', display: 'Chipotle pepper' },

  // Vanilla variants
  { pattern: /\b(vanilla|vanilla extract|pure vanilla extract|vanilla bean)\b/i, canonical: 'vanilla extract', display: 'Vanilla extract' },

  // Chocolate variants
  { pattern: /\b(chocolate chip|semi[- ]?sweet chocolate chip|milk chocolate chip|dark chocolate chip)\b/i, canonical: 'chocolate chips', display: 'Chocolate chips' },
  { pattern: /\b(cocoa powder|unsweetened cocoa|dutch[- ]?process cocoa)\b/i, canonical: 'cocoa powder', display: 'Cocoa powder' },
  { pattern: /\b(baking chocolate|unsweetened chocolate)\b/i, canonical: 'baking chocolate', display: 'Baking chocolate' },

  // Baking essentials
  { pattern: /\b(baking soda|bicarbonate of soda)\b/i, canonical: 'baking soda', display: 'Baking soda' },
  { pattern: /\b(baking powder)\b/i, canonical: 'baking powder', display: 'Baking powder' },
  { pattern: /\b(yeast|active dry yeast|instant yeast|rapid rise yeast)\b/i, canonical: 'yeast', display: 'Yeast' },
  { pattern: /\b(cornstarch|corn starch)\b/i, canonical: 'cornstarch', display: 'Cornstarch' },

  // Mayonnaise variants
  { pattern: /\b(mayonnaise|mayo|light mayo|low[- ]?fat mayo)\b/i, canonical: 'mayonnaise', display: 'Mayonnaise' },

  // Ketchup
  { pattern: /\b(ketchup|catsup|tomato ketchup)\b/i, canonical: 'ketchup', display: 'Ketchup' },

  // Worcestershire
  { pattern: /\b(worcestershire sauce|worcestershire)\b/i, canonical: 'worcestershire sauce', display: 'Worcestershire sauce' },

  // Hot sauce
  { pattern: /\b(hot sauce|tabasco|franks|louisiana hot sauce|sriracha)\b/i, canonical: 'hot sauce', display: 'Hot sauce' },
];
...
function processBellPepperGroup(canonicalKey, displayName, items, sourceLines) {
  ...
  for (const item of items) {
    ...
    if (item.quantity !== null && item.quantity !== undefined) {
      ...
      const numericQty = typeof item.quantity === 'string' ? parseFloat(item.quantity) : Number(item.quantity);
      if (!isNaN(numericQty)) {
...
function sumQuantities(items) {
  ...
  for (const item of items) {
    ...
    if (item.quantity !== null && item.quantity !== undefined) {
      ...
      const numericQuantity = typeof item.quantity === 'string' ? parseFloat(item.quantity) : Number(item.quantity);
